...
require (
	...
	github.com/hashicorp/vault v1.23.3
...
// Pin vault version due to non-standard versioning
//nolint:gomoddirectives // Required for vault's non-standard versioning
replace github.com/hashicorp/vault => github.com/hashicorp/vault v1.21.0
