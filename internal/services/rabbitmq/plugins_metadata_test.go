...
func TestPluginsMetadataService_GetCommandsByCategory(t *testing.T) {
	...
	tests := getCommandsByCategoryTestCases()

	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			testGetCommandsByCategory(t, service, test)
		})
	}
}

func getCommandsByCategoryTestCases() []struct {
	name           string
	category       string
	expectError    bool
	expectCommands bool
...
func testGetCommandsByCategory(t *testing.T, service *PluginsMetadataService, test struct {
	name           string
	category       string
	expectError    bool
	expectCommands bool
...
func TestPluginsMetadataService_GetCommand(t *testing.T) {
	...
	tests := getCommandTestCases()

	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			testGetCommand(t, service, test)
		})
	}
}

func getCommandTestCases() []struct {
	name        string
	command     string
	expectError bool
} {
...
func testGetCommand(t *testing.T, service *PluginsMetadataService, test struct {
	name        string
	command     string
	expectError bool
}) {
...
func TestPluginsMetadataService_ValidateCommand(t *testing.T) {
	...
	tests := getValidateCommandTestCases()

	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			testValidateCommand(t, service, test)
		})
	}
}

func getValidateCommandTestCases() []struct {
	name        string
	command     string
	arguments   []string
	expectError bool
...
func testValidateCommand(t *testing.T, service *PluginsMetadataService, test struct {
	name        string
	command     string
	arguments   []string
	expectError bool
...
func TestValidatePluginNames(t *testing.T) {
	...
	tests := getValidatePluginNamesTestCases()

	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			testValidatePluginNames(t, service, test)
		})
	}
}

func getValidatePluginNamesTestCases() []struct {
	name        string
	pluginNames []string
	expectError bool
} {
...
func testValidatePluginNames(t *testing.T, service *PluginsMetadataService, test struct {
	name        string
	pluginNames []string
	expectError bool
}) {
