...
// IsRabbitMQPluginsMetadataService implements the interfaces.RabbitMQPluginsMetadataService interface.
func (p *PluginsMetadataService) IsRabbitMQPluginsMetadataService() bool {
	return true
}

// initializeHelpCategory initializes help command category.
func (p *PluginsMetadataService) createHelpCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "help",
...
func (p *PluginsMetadataService) createAutocompleteCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "autocomplete",
...
func (p *PluginsMetadataService) createVersionCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "version",
...
func (p *PluginsMetadataService) initializeHelpCategory() {
	...
	helpCmd := p.createHelpCommand()
	autocompleteCmd := p.createAutocompleteCommand()
	versionCmd := p.createVersionCommand()
...
func (p *PluginsMetadataService) createDirectoriesCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "directories",
...
func (p *PluginsMetadataService) createIsEnabledCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "is_enabled",
...
func (p *PluginsMetadataService) initializeMonitoringCategory() {
	...
	directoriesCmd := p.createDirectoriesCommand()
	isEnabledCmd := p.createIsEnabledCommand()
...
func (p *PluginsMetadataService) initializePluginManagementCategory() {
	...
	listCmd := p.createListPluginCommand()
	enableCmd := p.createEnablePluginCommand()
	disableCmd := p.createDisablePluginCommand()
	setCmd := p.createSetPluginCommand()
...
func (p *PluginsMetadataService) createListPluginCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "list",
...
func (p *PluginsMetadataService) createEnablePluginCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "enable",
...
func (p *PluginsMetadataService) createDisablePluginCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "disable",
...
func (p *PluginsMetadataService) createSetPluginCommand() RabbitMQPluginsCommand {
	return RabbitMQPluginsCommand{
		Name:        "set",
