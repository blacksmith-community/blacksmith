...
shipit: ## Build release artifacts (requires VERSION env var)
	...
	@cp artifacts/blacksmith-linux-amd64 blacksmith-$(VERSION)/blacksmith-linux-amd64
	@cp artifacts/blacksmith-darwin-amd64 blacksmith-$(VERSION)/blacksmith-darwin-amd64
	@cp artifacts/blacksmith-darwin-arm64 blacksmith-$(VERSION)/blacksmith-darwin-arm64
